...
variable "iso_checksum" {
  type    = string
  default = "466add7fb5ba7caebd27bf6b8b326a24857295673045d643950869f5f0440c44ae833dea49c7b8a674afbf82c3f41ceb5062948aea443d581bc827db62cc5249"
}
...
variable "preseed_qemu_path" {
  type    = string
  default = "debian10/preseed_qemu.cfg"
}

variable "preseed_virtualbox_path" {
  type    = string
  default = "debian10/preseed.cfg"
}
...
locals {
  iso_template_url = "https://cdimage.debian.org/cdimage/archive/${var.iso_debian_version}/amd64/iso-cd/debian-${var.iso_debian_version}-amd64-netinst.iso"
}
