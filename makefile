...
image_debian_vbox_headless:
	...
	cd ./debian && ./build_virtualbox.sh -var 'headless=true' debian12.1.pkr.hcl
...
image_debian_vbox:
	...
	cd ./debian && ./build_virtualbox.sh debian12.1.pkr.hcl
...
image_debian_big_vbox:
	...
	cd ./debian && ./build_virtualbox.sh -var "disk_size=20000" -var "preseed_virtualbox_path=debian11/preseed-big.cfg" debian12.1.pkr.hcl
